                    ...
                    <tbody>
                        @forelse($repositories as $repository)
                            <tr>
                                ...
                                <td class="border px-4 py-2"><a href="{{ route('repositories.show',$repository) }}">Ver</a></td>
                                <td class="border px-4 py-2"><a href="{{ route('repositories.edit',$repository) }}">Editar</a></td>
